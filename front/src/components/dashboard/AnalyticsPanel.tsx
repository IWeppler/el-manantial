        ...
        <thead className="bg-gray-100 sticky top-0">
          <tr>
            ...
            <th className="p-3 text-left font-semibold text-gray-600">
              {title === "Historial de Producción" ? "Cantidad" : "Descripción"}
            </th>
...
const expenseValidation = Yup.object({
  ...
  category: Yup.string()
    ...
    .required("La categoría es requerida."), // <-- Añadimos la validación
});
    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <StatsCard
          ...
          icon={<FaEgg size={24} className="text-yellow-500" />}
        />
        <StatsCard
          title="Huevos Vendidos"
          value={analytics.totalEggsSold.toLocaleString()}
          icon={<FaArrowUp size={24} className="text-green-500" />}
        />
        <StatsCard
          title="Balance de Huevos"
          value={analytics.eggBalance.toLocaleString()}
          icon={<FaBalanceScale size={24} className="text-blue-500" />}
        />
        <StatsCard
        ...
        <StatsCard
          ...
          icon={<FaArrowDown size={24} className="text-red-500" />}
        />
        <StatsCard
          title="Ganancia Neta"
            ...
            {({ isSubmitting }) => (
              <Form className="space-y-4">
                ...
                <button
                  ...
                  className="w-full rounded-md bg-neutral-900 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-neutral-800 disabled:opacity-50"
                >
